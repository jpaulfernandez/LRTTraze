...
class DispatchController extends Controller_1.default {
    constructor() {
        super();
    }
    executeCommand(req, res, next) {
        let data = req.body;
        commandRegistry_1.handler(data, function () {
            res.sendStatus(200);
        });
...
__decorate([
    Route_1.post('/')
], DispatchController.prototype, "executeCommand", null);
exports.default = DispatchController;
